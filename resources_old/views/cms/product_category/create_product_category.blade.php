                ...
                <form class="form-validate" id="create-products-category" action="#" method="post">
                    ...
                    @if ($data->category_image)
                        <div class="form-group row d-none">
                            <label class="col-lg-3 col-form-label" for="">Category Image<span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-6">
                                <input style="width:200px;" type="hidden" value="{{ $data->category_image }}"
                                    class="form-control-file" id="category_image" name="category_image">
                            </div>
                        </div>
                    @else
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label" for="">Category Image<span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-6">
                                <input style="width:200px;" type="file" class="form-control-file" id="category_image"
                                    name="category_image">
                            </div>
                        </div>
                    @endif
