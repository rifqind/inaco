        ...
        <div class="card m-b-30">
            <div class="card-body">
                ...
                <form class="form-validate" id="create-user" action="" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select class="form-control select2-single" id="role_id" name="role_id"
                                ...
                                <option value="{{ $value->id }}" {{ $data->role_id == $value->id ?'selected' : '' }}>{{ $value->role_name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="user_status" id="user_status2"
                                    value="0" {{ $data->user_status == 0 ? 'checked' : '' }}>
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label" for="password_confirmation">Password Confirmation</label>
                        <div class="col-lg-6">
