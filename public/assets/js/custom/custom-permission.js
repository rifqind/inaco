...
if (path == "/webappcms/permissions") {
            ...
            button.addEventListener("click", (e) => {
                ...
                Swal.fire({
                    ...
                    if (value.isConfirmed) {
                        jQuery.ajax({
                            url: "/webappcms/permission/destroy/" + id,
                            type: "DELETE",
                            data: {
    ...
    document.addEventListener("DOMContentLoaded", () => {
        jQuery("#create-permission").validate({
            ignore: [],
            ...
            submitHandler: function () {
                ...
                jQuery.ajax({
                    url: "/webappcms/permissions/create",
                    type: "POST",
                    data: formData,
                    headers: {
                    ...
                    success: (data) => {
                        if (data.message) {
                            Swal.fire({
                                ...
                                text: "Continue to add new permission?",
                                icon: "success",
                                ...
                                if (value.isDismissed) {
                                    window.location.href =
                                        "/webappcms/permissions"; // Ganti dengan URL tujuan Anda
                                }
                            });
                        } else if (data.error) {
                            alert(data.error);
        ...
        document.getElementById("back").addEventListener("click", () => {
            window.location.href = "/webappcms/permissions";
        });
    });
}
