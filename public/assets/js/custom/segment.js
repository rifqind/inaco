...
if (path == "/webappcms/segment") {
            ...
            button.addEventListener("click", (e) => {
                ...
                Swal.fire({
                    ...
                    if (value.isConfirmed) {
                        jQuery.ajax({
                            url: "/webappcms/segment/destroy/" + id,
                            type: "DELETE",
                            data: {
    ...
    document.addEventListener("DOMContentLoaded", () => {
        document.getElementById("back").addEventListener("click", () => {
            window.location.href = "/webappcms/segment";
        });
    });
    jQuery("#create-banner").validate({
        ...
        messages: {
            ...
            segment_description: {
                required: "Please enter segment description",
            },
        },
        submitHandler: function () {
            ...
            jQuery.ajax({
                url:
                    path == "/webappcms/segment/create"
                        ? "/webappcms/segment/store"
                        : "/webappcms/segment/update",
                type: "POST",
                data: formData,
                headers: {
                    ...
                    if (data.message) {
                        Swal.fire({
                            ...
                            if (value.isDismissed) {
                                window.location.href = "/webappcms/segment"; // Ganti dengan URL tujuan Anda
                            }
                        });
                    } else if (data.error) {
                        Swal.fire({
