...
?>
	...
	<section id="hero" class="pt-0 text-white" data-aos="fade-in">
		...
		<div class="hero-img">
		  <img src="assets/images/findus/findus-hero.jpg" class="img-fluid" alt="Artikel Inaco">
		</div>
			...
			<div class="row justify-content-center">
				<div class="col-12 col-sm-5">
					...
					<div class="d-flex align-items-start mb-3">
						<img src="assets/images/findus/location.png" class="me-3">
						<div class="">
					...
					<div class="d-flex align-items-start mb-3">
						<img src="assets/images/findus/call.png" class="me-3">
						<div class="">
					...
					<div class="d-flex align-items-start mb-3">
						<img src="assets/images/findus/message.png" class="me-3">
						<div class="">
					...
					<div class="d-flex align-items-start mb-3">
						<img src="assets/images/findus/printer.png" class="me-3">
						<div class="">
					...
					<div class="d-flex align-items-center olshop">
						<a class="me-3" href=""><img src="assets/images/findus/lazada.png"></a>
						<a class="me-3" href=""><img src="assets/images/findus/tiktok.png"></a>
						<a class="me-3" href=""><img src="assets/images/findus/tokopedia.png"></a>
						<a class="me-3" href=""><img src="assets/images/findus/shopee.png"></a>
					</div>
				...
				<div class="col-12 col-sm-7">
					<form action="">
						...
						<button href="recipe-detail.php" class="btn btn-primary px-5 more filled-button">Submit</button>
					</form>
				</div>
			</div>
		</div>
