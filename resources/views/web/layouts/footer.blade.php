            ...
            <div class="row justify-content-between">
                ...
                @if($code == 'id')
                    <div class="col-md-2 col-6">
                        <ul>
                            <li><a href="{{ route('web.about', ['code' => $code]) }}">Perusahaan</a></li>
                    ...
                    <div class="col-md-3 col-6 ps-0">
                        <ul>
                            ...
                            <li><a href="{{ route('web.news', ['id' => 'articles', 'code' => $code]) }}">Berita</a></li>
                ...
                @elseif ($code == 'vi')
                    <div class="col-md-2 col-6">
                        <ul>
                            <li><a href="{{ route('web.about', ['code' => $code]) }}">Công Ty</a></li>
                    ...
                    <div class="col-md-3 col-6 ps-0">
                        <ul>
                            ...
                            <li><a href="{{ route('web.news', ['id' => 'articles', 'code' => $code]) }}">Tin Tức</a></li>
                ...
                @elseif ($code == 'ar')
                    <div class="col-md-2 col-6">
                        <ul>
                            <li><a href="{{ route('web.about', ['code' => $code]) }}">شركة</a></li>
                    ...
                    <div class="col-md-3 col-6 ps-0">
                        <ul>
                            ...
                            <li><a href="{{ route('web.news', ['id' => 'articles', 'code' => $code]) }}">أخبار</a></li>
                ...
                @else
                    <div class="col-md-2 col-6">
                        <ul>
                            <li><a href="{{ route('web.about', ['code' => $code]) }}">Company</a></li>
                    ...
                    <div class="col-md-3 col-6 ps-0">
                        <ul>
                            ...
                            <li><a href="{{ route('web.news', ['id' => 'articles', 'code' => $code]) }}">News</a></li>
