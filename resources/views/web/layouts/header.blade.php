    ...
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar w-100 justify-content-between">
            <ul class="w-100 justify-content-between">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                        ...
                        <li class="changeLang">
                            <a class="dropdown-item" href="#" id="change-to-{{ strtolower($value->code) }}">
                                <img title="{{ $value->name }}" src="{{ asset('data/language') . '/' . $value->icon_image }}">
                            </a>
                        </li>
                        @endforeach
                    </ul>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <div class="row list-megamenu">
                                    <div class="col-sm-3">
                                        @if($code == 'id')
                                        <div class="megamenu-item"><a href="{{ route('web.about', ['code' => $code]) }}">Tentang Kami</a></div>
                                        <div class="megamenu-item"><a href="{{ route('web.company-profile', ['code' => $code]) }} ">Profil Perusahaan</a></div>
                                        <div class="megamenu-item"><a href="{{ route('web.factory-tour', ['code' => $code]) }}">Tur Pabrik</a></div>
                                        <div class="megamenu-item"><a href="{{ route('web.awards', ['code' => $code]) }}">Penghargaan</a></div>
                                        <div class="megamenu-item"><a href="{{ route('web.find-us', ['code' => $code]) }}">Temukan Kami</a></div>
                                        @elseif($code == 'ar')
                                        <div class="megamenu-item"><a href="{{ route('web.about', ['code' => $code]) }}">معلومات عنا</a></div>
                                        <div class="megamenu-item"><a href="{{ route('web.company-profile', ['code' => $code]) }} ">ملف الشركة</a></div>
                                        <div class="megamenu-item"><a href="{{ route('web.factory-tour', ['code' => $code]) }}">جولة في المصنع</a></div>
                                        ...
                                        <div class="megamenu-item"><a href="{{ route('web.company-profile', ['code' => $code]) }} ">Company Profile</a></div>
                                        <div class="megamenu-item"><a href="{{ route('web.factory-tour', ['code' => $code]) }}">Factory Tour</a></div>
                ...
                @elseif ($code == 'id')
                <li class="nav-item"><a class="nav-link" href="{{ route('web.recipe', ['code' => $code]) }}">Resep</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ route('web.distributor', ['code' => $code]) }}">Distributor</a></li>
                <li class="nav-item logo-item d-none d-sm-block"><a class="nav-link" href="/"><img title="Logo Inaco" src="{{ asset('assets/web/images/logo.png') }}"></a></li>
                <li class="nav-item"><a class="nav-link" href="{{ route('web.intermarket', ['code' => $code]) }}">Pasar Internasional</a></li>
                @else
                            ...
                            <div class="col-sm-9">
                                <div class="row list-megamenu">
                                    <div class="col-sm-3">
                                        ...
                                        @elseif ($code == 'id')
                                        <div class="megamenu-item"><a href="{{ route('web.news', ['id' => 'articles', 'code' => $code]) }}">Artikel</a></div>
                ...
                @elseif ($code == 'id')
                <li class="nav-item"><a class="nav-link" href="{{ route('web.careers', ['code' => $code]) }}">Karir</a></li>
                @else
