            ...
            <div class="container">
                <div class="row w-100" data-aos="fade-up">
                    <div class="col-12 col-md-4">
                        ...
                        @if ($code == 'ar')
                        <a href="{{ route('web.products', ['code' => $code]) }}" class="btn btn-primary more filled-button d-none d-sm-inline">انظر جميع المنتجات</a>
                        @else
                        <a href="{{ route('web.products', ['code' => $code]) }}" class="btn btn-primary more filled-button d-none d-sm-inline">Lihat Semua Produk</a>
                        @endif
                    </div>
                </div>
            </div>
            <div class="container-fluid overflow-hidden px-0">
                <div class="row justify-content-end">
                    ...
                    <div class="col-12 text-center">
                        <a href="{{ route('web.products', ['code' => $code]) }}" class="btn btn-primary more filled-button d-inline-block d-sm-none mt-4">Lihat Semua Produk</a>
                    </div>
                </div>
            </div>
        </section>
