...
?>
	...
	<section id="catalog-detail" class="catalog-anak mt-5 pb-4">
			...
			<div class="row">
				...
				<div class="col-md-7">
					<div id="image-detail" class="image-catalog-detail mb-4 mb-sm-0">
						<img src="assets/images/catalog/catalog-detail-anak.png">
					</div>
				</div>
				<div class="col-md-5">
					<h1 class="title-catalog">Konnyaku</h1>
					<h2 class="subtitle-catalog">Jelly</h2>
					<div class="detail-catalog">
						<p>Jelly No #1. Fun & Great Tasting Jelly that is made from carageenan powder, real sugar, authentic fruit taste, our signature Nata De Coco cubes with 100% coconut milk and added the “superfood” KONJAC Powder, packed in small cups.</p>
						<ul>
							<li>Content : 2kg</li>
							<li>Carton size : 510 x 340 x 165 mm</li>
							<li>Flavor : Mix Flavor (Lychee, Melon, Passion Fruit, Guava, Blackcurrant, Peach)</li>
						</ul>
					</div>
					...
					<div class="catalog-list row">
						<div class="col-12 col-md-3">
							<div class="catalog-thumbnail">
								...
								<a href="catalog-detail-anak.php" class="btn btn-primary btn-anak btn-more">Lihat Produk</a>
							</div>
						</div>
						<div class="col-12 col-md-3">
							<div class="catalog-thumbnail">
