        ...
        <div class="card m-b-30">
            <div class="card-body">
                ...
                <form class="form-validate" action="{{ route('menu.store') }}" method="post">
                    ...
                    <div class="form-group row {{ $data->on_cms ? 'd-none' : '' }}">
                        <label class="col-lg-3 col-form-label" for="val-phoneus">Display on Cms<span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="on_cms" id="on_cms1"
                                    value="1" {{ $data->on_cms == 1 ? 'checked' : '' }}>
                                <label class="form-check-label" for="on_cms1">Yes</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="on_cms" id="on_cms2"
                                    value="0" {{ $data->on_cms == 0 ? 'checked' : '' }}>
