        ...
        <div class="card m-b-30">
            <div class="card-body">
                ...
                <form class="form-validate" action="/menu/update" method="post">
                    ...
                    <input id="menu-translation-id" name="menu_translation_id" type="hidden"
                        value="{{ $data->menu_translation_id }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" class="form-control" id="menu-title" name="menu_title"
                                placeholder="Enter Title" value="{{ $data->menu_title }}">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label" for="menu_web_url">URL Website<span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input value="{{ $data->menu_web_url }}" type="text" class="form-control"
                                id="menu_web_url" name="menu_web_url" placeholder="Enter URL">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label" for="menu_cms_url">URL CMS<span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input value="{{ $data->menu_cms_url }}" type="text" class="form-control"
                                id="menu_cms_url" name="menu_cms_url" placeholder="Enter URL">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label" for="icon_on_cms">Icon on CMS<span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input value="{{ $data->icon_on_cms }}" type="text" class="form-control"
                                id="icon_on_cms" name="icon_on_cms" placeholder="Enter Script Icon">
                        </div>
