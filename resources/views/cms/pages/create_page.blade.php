            ...
            <div class="card-body">
                ...
                <form class="form-validate" id="create-page" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label" for="pages_title">Title<span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" class="form-control" id="pages_title" name="pages_title"
                                placeholder="Enter Title">
                            <div class="invalid-feedback">Please enter the title</div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label" for="pages_description">Content Description <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                    ...
                    @if ($data->pages_image)
                        <div class="form-group row d-none">
                            <label class="col-lg-3 col-form-label" for="">Page Image<span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-6">
                    ...
                    <div class="form-group row {{ $data->pages_status ? 'd-none' : '' }}">
                        <label class="col-lg-3 col-form-label" for="val-phoneus">Page Status<span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="pages_status" id="pages_status1"
                                    value="1" {{ $data->pages_status == 1 ? 'checked' : '' }}>
                                <label class="form-check-label" for="pages_status1">Active</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="pages_status" id="pages_status2"
                                    value="0" {{ $data->pages_status == 0 ? 'checked' : '' }}>
