        ...
        <div class="card m-b-30">
            <div class="card-header pt-0">
                <div class="d-sm-flex justify-content-between">
                    <a href="{{ route('socmed-marketplace.create') }}" class="btn btn-primary-rgba position-absolute"><i class="feather icon-plus mr-2"></i>Add New</a>
                </div>
            </div>
            <div class="card-body">
                <div class="">
                    ...
                    <table id="datatable-socmed" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr data-id="{{ $value->id }}">
                                ...
                                <td>{{ $value->youtube }}</td>
                                <td>{{ $value->twitter }}</td>
                                <td><a href="{{ route('socmed-marketplace.update', ['id' => $value->id]) }}" class="btn btn-round btn-success" data-toggle="tooltip" data-placement="top" title="Edit"><i class="feather icon-edit"></i></a>
