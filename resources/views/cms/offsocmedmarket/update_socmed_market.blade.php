            ...
            <div class="card-body">
                ...
                <form class="form-validate" action="/menu/update" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" value="{{ $data->instagram }}" class="form-control" id="instagram" name="instagram" placeholder="Enter Link">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label" for="facebook">Facebook Link<span class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" value="{{ $data->facebook }}" class="form-control" id="facebook" name="facebook" placeholder="Enter Link">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label" for="tiktok">Tiktok Link<span class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" value="{{ $data->tiktok }}" class="form-control" id="tiktok" name="tiktok" placeholder="Enter Link">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label" for="youtube">Youtube Link<span class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" value="{{ $data->youtube }}" class="form-control" id="youtube" name="youtube" placeholder="Enter Link">
                        </div>
                    </div>
                    <div class="form-group row m-b-30">
                        ...
                        <div class="col-lg-6">
                            <input type="text" value="{{ $data->twitter }}" class="form-control" id="twitter" name="twitter" placeholder="Enter Link">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" value="{{ $data->shopee }}" class="form-control" id="shopee" name="shopee" placeholder="Enter Link">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label" for="tokopedia">Tokopedia Link<span class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" value="{{ $data->tokopedia }}" class="form-control" id="tokopedia" name="tokopedia" placeholder="Enter Link">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label" for="lazada">Lazada Link<span class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" value="{{ $data->lazada }}" class="form-control" id="lazada" name="lazada" placeholder="Enter Link">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label" for="tiktokshop">Tiktokshop Link<span class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" value="{{ $data->tiktokshop }}" class="form-control" id="tiktokshop" name="tiktokshop" placeholder="Enter Link">
                        </div>
                    </div>
