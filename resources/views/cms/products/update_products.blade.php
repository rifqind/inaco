                ...
                <form class="form-validate" id="create-products" action="" method="post"
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label" for="product_title">Product Name<span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" value="{{ $data->product_title }}" class="form-control"
                                id="product_title" name="product_title" placeholder="Enter Name">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <div class="input-group mb-3 align-items-center">
                                <input type="file" class="form-control-file w-auto" id="product_image_update"
