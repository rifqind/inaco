            ...
            <div class="card-body">
                ...
                <form class="form-validate" id="create-products-category" action="#" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" value="{{ $data->category_title }}" class="form-control" id="category_title" name="category_title" placeholder="Enter Name">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select class="form-control" id="segment_id" name="segment_id" style="width:200px;">
                                ...
                                <option value="{{ $value->value }}" {{ $data->segment_id == $value->value ? 'selected' : '' }}>{{ $value->label }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input style="width:200px;" type="file" class="form-control-file" id="category_image_update" name="category_image_update">
