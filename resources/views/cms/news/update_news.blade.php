            ...
            <div class="card-body">
                ...
                <form class="form-validate" id="create-news" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" value="{{ $data->news_title }}" class="form-control" id="news_title" name="news_title" placeholder="Enter Title">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <div class="input-group" style="width:200px;">
                                <input type="text" name="create_date_update" id="autoclose-date" class="datepicker-here form-control" placeholder="dd/mm/yyyy" aria-describedby="basic-addon3" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="file" class="form-control-file" id="news_image_update" name="news_image_update">
