                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('login') }}" method="POST" id="form-login">
                                        ...
                                        <button type="submit"
                                            class="btn btn-danger btn-lg btn-block font-18">Login</button>
                                    </form>
                                    <div class="form-footer">
                                        <img src="{{ asset('assets/images/maskot.png') }}" class="img-maskot"
                                            alt="logo">
                                    </div>
                                </div>
                            </div>
                ...
                $.ajax({
                    ...
                    error: (data) => {
                        ...
                        if (message == 'These credentials do not match our records.') {
                            document.querySelector('.error-message').textContent = 'Email/Password is incorrect.';
                        } else {
